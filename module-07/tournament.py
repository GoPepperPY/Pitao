...
def battle(opponents: list[Opponent]) -> None:
    ...
    for counter_1 in range(qty_opponents):
        for counter_2 in range(counter_1 + 1, qty_opponents):
            factory1, strategy1 = opponents[counter_1]
            factory2, strategy2 = opponents[counter_2]
